...
- **Anisotropic materials** — Supports diagonally anisotropic media (`tidy3d.AnisotropicMedium`) and reciprocal fully anisotropic media (`tidy3d.FullyAnisotropicMedium` with symmetric permittivity and conductivity tensors).
