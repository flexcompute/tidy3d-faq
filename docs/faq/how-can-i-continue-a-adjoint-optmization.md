# How Can I Continue a Adjoint Optmization?

| Date       | Category    |
|------------|-------------|
| 2025-06-19 14:55:02 | Inverse Design |
...
The [Parameterized level set optimization of a y-branch](https://www.flexcompute.com/tidy3d/examples/notebooks/Autograd10YBranchLevelSet/) example illustrates this approach.
