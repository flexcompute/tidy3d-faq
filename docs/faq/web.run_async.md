...
The [`web.run_async`](https://docs.flexcompute.com/projects/tidy3d/en/latest/api/_autosummary/tidy3d.plugins.adjoint.web.run_async.html) function in Tidy3D allows you to submit and run multiple simulations in parallel on the server. It supports different simulation types (electromagnetic, heat, and EME) and automatically monitors, downloads, and loads the results into a [`web.BatchData`](https://docs.flexcompute.com/projects/tidy3d/en/latest/api/_autosummary/tidy3d.web.api.container.BatchData.html) object.
