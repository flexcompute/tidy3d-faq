...
A recommended approach is to perform a **convergence sweep**, where the simulation is run with increasing numbers of modes to analyze how the results converge. This process is demonstrated at the end of [this tutorial](https://www.flexcompute.com/tidy3d/examples/notebooks/EMESolver/).
