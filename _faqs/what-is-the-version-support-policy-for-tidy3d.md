---
title: What is the version support policy for Tidy3D?
date: 2026-02-02 12:00:00
enabled: true
category: "Installation and Help"
---
<div><p>Tidy3D follows <a target="_blank" rel="noopener" href="https://semver.org/">semantic versioning</a>. This means:</p></div>
...
<div><p><strong>Important exceptions:</strong></p></div>
...
<div><p><strong>Support lifecycle:</strong></p></div>
...
<div><p><strong>Pre-release versions:</strong></p></div>

<div><p>Release candidate (<code>rc</code>) and development (<code>dev</code>) versions are temporary and can be used to explore new features. However:</p></div>
