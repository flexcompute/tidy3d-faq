...
When using [`web.run`](https://docs.flexcompute.com/projects/tidy3d/en/latest/api/_autosummary/tidy3d.web.api.run.run.html){: .color-primary-hover} on multiple simulations, the returned object preserves the **same input structure**. This works for dictionaries, lists, tuples, and nested combinations of them.
